...
import { User, Phone, Mail, Shield, ToggleLeft, Lock, Eye, EyeOff } from 'lucide-react';
          ...
          <DialogBody className="space-y-5">
                  ...
                  <div className="group">
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-4 py-2.5 pr-10 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 hover:border-gray-400"
              ...
              <div className="pl-6 space-y-4">
                <div className="group">
                  ...
                  <p className="mt-1.5 text-xs text-gray-500">
                    ...
                    {formData.role === 'mechanic' && 'Can view and update assigned work'}
            ...
            <div className="space-y-4 pt-2">
              ...
              <div className="pl-6">
                ...
                <p className="mt-1.5 ml-7 text-xs text-gray-500">
